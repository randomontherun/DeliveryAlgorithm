...
def distance_between(address1, address2):  # Function to return distance between two addresses
...
def deliver_packages(truck):  # Function for delivering all the packages on the truck
...
class Main:
    ...
    user_input2 = input("\nTo demonstrate the lookup function at the given time, please enter 'lookup': ")
